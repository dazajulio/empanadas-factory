      ...
      <section id="storytelling" className="storytelling">
          <div className="container grid-2">
              ...
              <div className="story-image-container" style={{textAlign: 'center'}}>
                  ...
                  <video src="/assets/Conoce más sobre nuestra historia.mp4" controls preload="metadata" className="rounded-image shadow-large" style={{maxWidth: '80%', margin: '0 auto', display: 'block'}}></video>
              </div>
          </div>
