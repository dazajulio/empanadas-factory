...
export const menuData: MenuCategory[] = [
  {
    ...
    items: [
      { id: "m1", name: "Empanadas Picnic de Carne Molida", description: "Caja x 50 unidades. Empanadas precocidas listas para freír o calentar.", price: 0, image: "/assets/PicnicdeCarneMolida.png", popular: true },
